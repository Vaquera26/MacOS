...
- [Scripts para instalación](Instalar_SO/Scripts/Scripts.MD): Este archivo contiene scripts útiles para realizar la instalación y configuración de MacOS Big Sur en VirtualBox de manera automática.
...
¡Disfruta de tu experiencia con MacOS Big Sur en VirtualBox!
